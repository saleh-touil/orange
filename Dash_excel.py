...
df = pd.read_excel("https://raw.githubusercontent.com/Coding-with-Adam/Dash-by-Plotly/master/Analytic_Web_Apps/Excel_to_Dash_Animal_Shelter/Animals_Inventory.csv")
...
app.layout = html.Div([
    html.H1("Analytics Dashboard of ", style={"textAlign":"center"}),
    html.Hr(),
